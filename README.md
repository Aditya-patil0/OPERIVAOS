...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&amp;size=20&amp;duration=3000&amp;pause=1000&amp;color=3457D5&amp;center=true&amp;vCenter=true&amp;width=650&amp;lines=Project+lifecycle+management;Multi-level+approval+chains;Project-scoped+RBAC+by+design;Permission-scoped+AI+assistant" alt="Typing SVG" />

<br/>

| | | |
|:---:|:---:|:---:|
| 🏗️ **Modular Monolith** | 🔐 **Project-Scoped RBAC** | 🧠 **Permission-Scoped RAG** |
| ⛓️ **Append-Only History** | ⚙️ **Generic Approval Engine** | ⏱️ **SLA Auto-Escalation** |
...
<td align="center"><img src="https://skillicons.dev/icons?i=java" width="40"/><br/>Java 21</td>
...
🏢 Corporates · 🏛️ Government bodies · ⚖️ Law firms · 🤝 NGOs · 🏪 SMBs
